...
> **עובדים מול מסך משותף?** אם אתם בשיעור חי, בזום או בהקלטה, עצרו את שיתוף המסך לפני שאתם מקלידים את סיסמת המאסטר ולפני שאתם מזינים פרטי אשראי. אלה שני הרגעים היחידים ביחידה הזאת שבהם סוד יושב על המסך שלכם בגלוי.
...
1. נכנסים ל-bitwarden.com ופותחים חשבון חינמי. **סיסמת המאסטר** היא הסיסמה היחידה שתצטרכו לזכור — בחרו חזקה וייחודית. ‏Bitwarden דורש לפחות 12 תווים, אז קחו את זה בחשבון כבר עכשיו. שימו לב: אם תשכחו אותה, אין שחזור (זה המחיר של אפס-ידע), אז בחרו משהו שתזכרו.
...
```
   ...
   ולפני ששומרים — מסמנים את התיבה **Master Password Re-prompt**. כך לא ניתן יהיה לחשוף או להעתיק את המפתח ללא סיסמת המאסטר שלכם, אפילו כשהכספת פתוחה. זה הצעד שהכי קל לשכוח, והוא זה שמגן עליכם כשהשארתם את הכספת פתוחה והלכתם להכין קפה.
...
- יצרתם רשומת דמו עם שם ושדה key מוסתר, סימנתם Master Password Re-prompt — ומחקתם אותה.
...
4. המפתח מוצג על המסך **פעם אחת** — מחרוזת ארוכה של אותיות ומספרים. לא משנה באילו תווים הוא מתחיל; גוגל משנה את זה מדי פעם. מעתיקים אותו — ועוברים ישר ל-Bitwarden. (נסגר החלון לפני שהעתקתם? לא נורא — יוצרים מפתח חדש, אין מגבלה.)
...
בדיקה עצמית:
- הרשומה ב-Bitwarden מכילה שם ברור ושדה key מוסתר עם המפתח, ו-Master Password Re-prompt מסומן.

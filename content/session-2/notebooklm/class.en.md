...
1. **Open a new notebook** at notebooklm.google.com.
...
For a deeper, broader sweep, paste into Discover → Deep Research:
...
3. **Plants that are hard to kill** — sturdy houseplants, how much water they need, and how much light.
4. **A history of the board game** — how box games evolved, from the classics to today.
5. **A personal budget without the headache** — simple methods to track spending and save.

(All of them are easy to source, and all of them are concrete enough that you will see right away whether the output leans on the source or makes things up.)
...
Take two of the outputs that came out, say the table and the infographic, and compare them: which one organized the material better for you, and why. Or add a second source to the notebook (another research report, or a link), and ask a question that requires both sources together, and watch the answer point to both.

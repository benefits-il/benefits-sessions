...
- **חומר-המקור של המותג שלכם** — כל מה שכבר יש לכם בתיקייה, ובראשו מערכת-העיצוב שבניתם בשיעור 4 ‏(BUILD YOUR BRAND). זה בדיוק מה שצריך.
...
מדביקים בקלוד קוד את הפרומפט המוכן. קלוד יקרא את כל מה שיש לכם בתיקייה — ובראשו מערכת-העיצוב משיעור 4 — ישאל רק מה שחסר, ויכתוב DESIGN.md נקי.
